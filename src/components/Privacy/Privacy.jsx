  ...
  return (
    <div name="features" className="w-full h-screen bg-white flex flex-col ">
      ...
      <div className=" -mt-10 mb-16">
        <p>
<span className=" text-xl font-semibold">TCube-AI Company </span> is committed to protecting the privacy and security of your personal information. This Privacy Policy describes how we collect, use, and disclose information about you through our website [insert website URL] (the "Site").
