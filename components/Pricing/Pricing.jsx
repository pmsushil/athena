    ...
    <div  className='w-full text-white '>
      ...
      <div className='max-w-[1240px] mx-auto py-8'>
        ...
        <div className='text-center py-8 mt-4 text-slate-300'>
          <h2 className='text-3xl uppercase text-black font-bold'>Pricing</h2>
          <h3 className='text-4xl font-bold text-white py-8'>The right price for your Digital Visibility Needs in the Supply-Chain.</h3>
          <p className='text-3xl text-[#f9aa33]'>
        ...
        <div className='grid md:grid-cols-3'>
          ...
          <div className='bg-[white] text-[black] m-4 p-8 rounded-xl shadow-2xl relative'>
            ...
            <div className='text-2xl'>
                ...
                <p  className='flex py-4 text-blue-300 ml-10 ' >Billed Annually <br/>*Contact Your Rep for Your Discount </p>
                </div>
          ...
          <div className='bg-[#344955] text-[#f9aa33] m-4 p-8 rounded-xl shadow-2xl relative'>
            ...
            <div className='text-2xl'>
                ...
                <hr/>
                <div className=' flex flex-col -gap-3 '>
                <p  className='flex py-4 text-[#f9aa33] ml-10 ' >Billed Annually <br/>*Contact Your Rep for Your Discount </p>
                </div>
